...
# Jouons a la roulette
# Obtennir mise joueur (dolars)
# Obtennir le numero joué (0 à 49)
# Roulette se lance aléatoirement et obtiens un nulmero (0 à 49)
# Paires couleur noir impairs couleur rouge
# Sinumerp bon 3* mise
# Si mauvais mais couleur 50% de la mise
# sinon perdu
